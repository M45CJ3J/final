...
$customers = new customers ;
	  ...
	  $customers->setCustomerPassword($_POST['upd']);

	if(isset($_SESSION['Data']))
	{
	
    $_SESSION['Data'];
		 $customers->setCustomerUsername($_SESSION['Data']);   
     $customers->setCustomerPhoneNumber($_SESSION['Data']);
     $customers->setCustomerEmail($_SESSION['Data']);
echo(	$customers->UpdatePassword());

	session_destroy();	
}
else {
	$ss = $_GET['user'];
	$customers->setCustomerUsername($ss);   
     $customers->setCustomerPhoneNumber($ss);
     $customers->setCustomerEmail($ss);
...
<link href="forget/css/style.css" rel="stylesheet" type="text/css">
</head>
<body>
<!--element start here-->
<div class="elelment">
	...
	<div class="element-main">
		...
		<form method="post" class="gog">
			<input type="text" value="Your new password" name="upd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your e-mail address';}">
			<input type="submit" value="update my Password" name="update">
		</form>
	</div>
</div>
