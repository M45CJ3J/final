...
if(isset($_POST['dlt']))
{
  ...
  /*  $customers->setUsername($_SESSION['customers']);   
        $customers->setPhone($_SESSION['customers']);  */ 
        $customers->Deletecust($_SESSION['CUSTOMER']);
...
<div class="elelment">
	...
	<div class="element-main">
		...
		<!--	<input type="text" value="Your e-mail address" name="dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your e-mail address';}">-->
			<input type="submit" value="Deactivation" name="dlt">
		</form>
	</div>
</div>
