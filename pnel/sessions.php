...
<!--<div id="wrapper"></div>-->
    ...
    <?php
								   ...
								   $z = new cases;
								  $r = $z->RunSearch("Select * From cases");
 ...
 <form method="post">
 <label>number</label>
 <input type="text" value="<?php echo($rows['CasesNumber']); "<br/>"?>" style="width:70px;" />
<label>Casesdate</label>
 <input type="text" value="<?php echo($rows['Casesdate']); "<br/>" ?>" style="width:100px;" />
<label>CasesStatus</label>
 <input type="text" value="<?php echo($rows['CasesStatus']); "<br/>" ?>" style="width:90px;"   />  
<label>Email</label>
   <input type="text" value="<?php echo($rows['CustomerEmail']); "<br/>" ?>"  style="width:180px;"  />    
   ...
   <input type="submit" value="reject case" name="rjct">     
	  ...
	  if(isset($_POST['acpt'])){
		   ...
		   $d = new cases;
 $s = $d->zzz("INSERT INTO cases  OfficeUserName VALUES getOfficeUserName ","action done");
