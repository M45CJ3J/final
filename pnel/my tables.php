...
<!--<div id="wrapper"></div>-->
 ...
 <input disabled type="text" value="<?php echo($rows['Name']); "<br/>"?>" style="width:auto;" name="nm" />
...
<label>Case Details</label>
 ...
 <br/>
    ...
    <button><a href="<?php echo("replytemp.php?id=".$rows['ID']);?>" >to respond </a> </button>
    <button><a href="<?php echo("addcase.php?id=".$rows['ID']);?>" >to add the case </a> </button>
