                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                ...
                                <a href="register.php" class="reqe-button text-uppercase active">Register</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <div class="modal-body align-w3">
        <form action="#" method="post" class="p-sm-3">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="your username" name="username" id="recipient-name"
                    required="">
            </div>
      ...
      <div class="form-group">
            ...
            <div class="right-w3l">
                <input type="submit" class="form-control bg-theme" value="Register" name="btnregst">
            </div>
        </form>
    </div>
