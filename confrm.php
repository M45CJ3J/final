...
<div class="elelment">
	...
	<div class="element-main">
		...
		<form method="post" class="gog">
			<input type="text" value="Your confirm" name="confrm" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your e-mail address';}">
			<input type="submit" value="update my Password" name="conf">
		</form>
	</div>
</div>
