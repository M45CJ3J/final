...
require './vendor/autoload.php';    
  if(isset($_POST['pas']))
  {
     ...
     //$customers->setCustomerUsername($_POST['po']);   
     //$customers->setCustomerPhoneNumber($_POST['po']);
     $customers->setCustomerEmail($_POST['po']);
     $us=$_POST['po'];
      
     $r= $customers->CheckUser();
        
     if($rows=mysqli_fetch_assoc($r))
           {
          //$phone=$rows['CustomerPhoneNumber']  ;
            $email=$rows['CustomerEmail'];
            $name=$rows['CustomerFirst'];
...
$mail->Username = "Schoolnti0@gmail.com";
$mail->Password = "#NTI@159357456258";

$mail->setFrom('Schoolnti0@gmail.com', 'The law');
$mail->addAddress($email, $name );

$mail->Subject = 'Forget Password Our School';
$mail->Body = 'visit this link http://localhost/school/setNewPassword.php?user='.$us;
...
<link href="forget/css/style.css" rel="stylesheet" type="text/css" media="all"/>
<!-- Custom Theme files -->
...
<div class="elelment">
	...
	<div class="element-main">
		...
		<form method="post">
                  <input class="form-check-input"   type="radio" name="forget" id="email" value="Email">
                <label class="form-check-label mr-5 text-white" for="email">
                  By Email
                </label>
                  <input class="form-check-input "   type="radio" name="forget" id="sms" value="SMS">
                <label class="form-check-label text-white" for="sms">
                  By SMS
                </label>
                <br>
			<input type="text" value="Your e-mail address" name="po" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your e-mail address';}">
			<input type="submit" value="Reset my Password" name="pas">
		</form>
	</div>
</div>
