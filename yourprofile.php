...
<body>
	...
	include_once 'customers.php';
		...
		//$customers->setCustomerFirst($_SESSION['CUSTOMER']);
		$customers->setCustomerUsername($_SESSION['CUSTOMER']);
		//$customers->setCustomerPassword($_SESSION['CUSTOMER']);
		//$customers->setCustomerPhoneNumber($_SESSION['CUSTOMER']);
		//$customers->setCustomerEmail($_SESSION['CUSTOMER']);
		
			$r = $customers-> RunSearch("Select * From customers where CustomerUsername = '".$_SESSION['CUSTOMER']."'  ");
	...
	?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo($rows['CustomerFirst']); ?>" placeholder="your name" name="name" id="recipient-name"
                    >
            </div>
           
            <div class="form-group">
                <label for="recipient-name" class="col-form-label">Username</label>
                <input type="text" class="form-control" placeholder="your username" name="username" value="<?php echo($rows['CustomerUsername']); ?>" id="recipient-name"
                    >
            </div>
           
      <div class="form-group">
                <label for="password1" class="col-form-label">Password</label>
                <input type="password" class="form-control" value="<?php echo($rows['CustomerPassword']); ?>" placeholder="******" name="Password" id="password1"
                    >
            </div>
          
            <div class="form-group">
                <label for="password2" class="col-form-label">Phone</label>
                <input type="text" class="form-control" placeholder="your phone" value="<?php echo($rows['CustomerPhoneNumber']); ?>" name="phone" id="password2"
                    >
            </div>
              <div class="form-group">
                <label for="recipient-email" class="col-form-label">Email</label>
                <input type="email" class="form-control" placeholder="your mail" value="<?php echo($rows['CustomerEmail']); ?>" name="Email" id="recipient-email"
                    >
            </div>
            
            <a href="updateprofile.php">to update your profile</a>
             <div class="form-group">
