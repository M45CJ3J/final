...
$customers= new customers();
     ...
     $customers->setCustomerUsername($_POST['user']);
     $customers->setCustomerPassword($_POST['Password']);
   
     $rows=$customers->Login();
   
        if($rows)
        { if(isset($_POST['remember']))
             {
              setcookie("usercookie",$_POST['user'],time()+60*60*24*365);
             }
             $_SESSION['CUSTOMER']=$rows['CustomerUsername'];
            ...
            <div class="header d-lg-flex justify-content-between align-items-center py-sm-3 py-2 px-sm-2 px-1">
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            <li><a href="indexbefore.php">Home</a></li>
                            ...
                            <li class="nav-right-sty mt-lg-0 mt-sm-4 mt-3">
                                <a href="login.php" class="reqe-button text-uppercase active">Login</a>
    ...
    <div class="modal-body align-w3">
        <form action="#" method="post" class="p-sm-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="user name" name="user" id="recipient-name"
                    required=""  />
            </div>
            <div class="form-group">
            ...
            <div class="right-w3l">
                <input type="submit" class="form-control bg-theme" value="Login" id="a" onclick="x()"  name="Logins">
            </div>
            <div class="row sub-w3l my-3">
                ...
                <div class="col-sm-6 forgot-w3l text-sm-right">
                    <a href="forgetpass.php" class="text-secondary">Forgot Password?</a>
                </div>
            </div>
