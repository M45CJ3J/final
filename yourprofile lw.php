...
<body>
   ...
   if(isset($_GET['lw'])) {
	  include "lawyer.php";
	   ...
	   $case->setOfficeUsername($_GET['lw']);
	   $c = $case->xx();
      ...
      <div class="form-group">
                ...
                <input type="text" class="form-control" disabled value="<?php echo($rows['City']); ?>"  name="Password" id="password1"
                    >
            </div>
            ...
            <a href="contact.php">to book an appointment</a>
             <div class="form-group">
